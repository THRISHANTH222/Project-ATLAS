...
export class MimeDetector {
  private static readonly extMap: Record<string, string> = {
    pdf: 'application/pdf',
   ...
   */
  public static detect(buffer?: Buffer, filename?: string): { mimeType: string; extension: string } {
    let extension = '';
   ...
   */
  public static isSupported(extension: string, mimeType: string): boolean {
